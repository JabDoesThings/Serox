...
public class BMPLoader {
  ...
  public static BMPLoader instance = new BMPLoader();
  ...
  private short bitsPerPixel; // 1, 4, 8, or 24 (no color lvl)
  ...
  protected void getBitmapHeader() throws IOException {
    ...
    int colorsImportant; // no. of important colors (appear first in palette) (0 means all are
    // important)
    boolean topDown;
    int noOfPixels;
    size = readInt();
  ...
  protected void unpack(
      byte[] rawData, int rawOffset, int bpp, byte[] byteData, int byteOffset, int w)
      throws Exception {
    int j = byteOffset;
    int k = rawOffset;
    byte mask;
